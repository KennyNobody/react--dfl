...
export const App = ({className}: AppProps) => {
    ...
    const buttonHundler = (index: number): void => setTab(index);

    return (
        <section className={classNames(style['app'])}>
                    ...
                    >
                        {sectionTitles.map((value: string, index: number) => {
                            return <SwiperSlide
                                ...
                                key={value}
                            >
                                <ButtonAside caption={value} index={index} isActive={tab===index} setTab={buttonHundler}/>
                            </SwiperSlide>
                        })}
                    </Swiper>
                </div>
